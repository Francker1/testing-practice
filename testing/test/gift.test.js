...
import { canReconfigure } from '../src/gift'
...
describe('gift', () => {
  ...
  it('should return false if strings passed have different length', () => {
    expect(canReconfigure('abc', 'de')).toBe(false);
  });

  it('should return false if strings passed have different length even with same unique letters', () => {
